Repository นี้จัดทำขึ้นเพื่อส่งการบ้านหัวข้อ Software Testing โดยมีวัตถุประสงค์เพื่อทดสอบฟังก์ชันอัลกอริทึมจากโจทย์ HackerRank จำนวน 5 ข้อ โดยยึดหลักการเขียนโปรแกรมและทดสอบตามเกณฑ์มาตรฐานดังนี้:
